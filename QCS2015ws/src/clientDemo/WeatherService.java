 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8081/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://server/", "WeatherService");
    ...
    public Weather getWeatherPort() {
        return super.getPort(new QName("http://server/", "WeatherPort"), Weather.class);
    }
    ...
    public Weather getWeatherPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "WeatherPort"), Weather.class, features);
    }
